...
export default function Filter() {
    const filterList = {
        ...
        tiers: ["all","1","2","3","4","5","6","7","8"],
        enchantments:["all","0","1","2","3","4"]
    }
    ...
    return (
        <div className="filterBoxWrapper">
            ...
            <Filtercomponent activeFilter={activeFilter} filter={filter} renderList={renderList} handleActiveFilter={handleActiveFilter} type={"tiers"} styleWidth={"w-16 sm:w-20"}/>
            <Filtercomponent activeFilter={activeFilter} filter={filter} renderList={renderList} handleActiveFilter={handleActiveFilter} type={"enchantments"} styleWidth={"w-28 sm:w-32"}/>
        </div>
    )
}
    ...
    return (
        <>
           <div className="relative">
                ...
                <span className="filter-span">{type.charAt(0).toUpperCase() + type.slice(1)}</span>
                    {...renderList[type]}
                </div>
            </div>
        </>
