    ...
    if(readOnly) {
        ...
        return (
            <div className="inline-flex flex-col gap-1 lg:w-max">
                ...
                <div className="w-full h-full lg:w-44 bg-bg-transparent flex input-form items-center p-1">
                    <div className="h-fullpy-1 px-2 w-full text-gray-600 overflow-auto">{readOnlyText}</div>
                </div>
            </div>
        )
    }
